...
if os.getenv("LANGCHAIN_DEBUG") == "true":
    print("LangChain debug mode is enabled")
    set_debug(True)
...
class ReconApp:
    ...
    def __init__(
        ...
        print(
            f"""
            Supervisor Model: {self.supervisor_model}
            SQL Model: {self.sql_model}
            Finance Clerk Model: {self.finance_clerk_model}
